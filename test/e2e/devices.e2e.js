/**
 * E2E tests for device management (WebAuthn-registered devices)
 */
...
test.describe('Device Management', () => {
  ...
  test('should display devices list with metadata', async ({ page }) => {
    // Open settings modal and switch to Devices tab
    await openSettings(page);
    await switchSettingsTab(page, 'devices');
  ...
  test('should display device count correctly', async ({ page }) => {
    ...
    await page.click('.settings-tab[data-tab="devices"]');
