...
- **Information disclosure** — Are secrets (SETUP_TOKEN, session tokens) leaked in error responses, logs, or PTY environments? Are stack traces or internal paths exposed?
