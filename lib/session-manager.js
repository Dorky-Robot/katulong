...
export function createSessionManager({ bridge, shell, home, dataDir }) {
  ...
  // This sends complete (or near-complete) frames in a single WebSocket
  // message, allowing xterm.js DEC 2026 synchronized output to work
  // correctly and preventing partial-frame rendering artifacts.
