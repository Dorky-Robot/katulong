...
export class Session {
  ...
  /**
   * Force tmux to resend the visible pane content without changing dimensions.
   * Used on reconnect to trigger TUI redraws instead of the resize-toggle hack.
   */
  forceRefresh() {
    if (this.state !== Session.STATE_ATTACHED) return;
    this._sendControlCmd("refresh-client -S");
  }
