...
/**
 * List tmux sessions with attached client details.
 * Returns array of { name, hasExternalClient } where hasExternalClient is true
 * if any non-control-mode client is attached (e.g. SSH, terminal).
 */
...
export class Session {
  ...
  _handleStdoutData(chunk) {
    this._lineBuf = (this._lineBuf || "") + chunk.toString();
    let nlPos;
