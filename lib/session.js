...
import { TERMINAL_COLS, TERMINAL_ROWS_DEFAULT, TERMINAL_SCROLLBACK } from "./terminal-config.js";
import {
...
export class Session {
  ...
  constructor(name, tmuxName, options = {}) {
    ...
    this._headless = new Terminal({ cols: TERMINAL_COLS, rows: TERMINAL_ROWS_DEFAULT, scrollback: TERMINAL_SCROLLBACK, allowProposedApi: true });
