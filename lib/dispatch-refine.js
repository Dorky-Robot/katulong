...
export function createRefiner() {
  return {
    ...
    async refineBatch(store, featureIds, opts = {}) {
      ...
      // Track last bullet per feature to dedupe consecutive identical bullets
      ...
      return new Promise((resolve, reject) => {
        ...
        function processLine(line) {
          ...
          try {
            ...
            // Capture tool_use events for progress bullets
            ...
            // Also capture assistant text blocks as fallback
        ...
        function finish() {
          ...
          try {
            ...
            // Mark source features as grouped
            for (const f of features) {
