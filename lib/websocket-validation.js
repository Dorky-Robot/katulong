...
export function validateMessage(msg) {
  ...
  // NOTE: this skips ALL field-level validation — plugin wsHandlers must
  // validate their own fields (types, lengths, formats). The only outer
  // bound is the WS server's maxPayload (64 KB).
