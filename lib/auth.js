...
try {
  const watcher = watch(STATE_PATH, () => { _cachedState = undefined; });
  watcher.unref(); // Don't keep the process alive just for this watcher
} catch {
  // File may not exist yet; loadState handles it
}
