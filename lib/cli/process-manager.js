...
// Use env var if explicitly set; otherwise apply install-method-based default
const DATA_DIR = envConfig.dataDirExplicitlySet ? envConfig.dataDir : DEFAULT_DATA_DIR;
