...
const config = Object.freeze({
  ...
  dataDir: process.env.KATULONG_DATA_DIR || projectRoot,

  // Whether KATULONG_DATA_DIR was explicitly set (used by CLI to apply install-based defaults)
  dataDirExplicitlySet: Boolean(process.env.KATULONG_DATA_DIR),
