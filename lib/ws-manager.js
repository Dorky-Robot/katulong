  ...
  function handleConnection(ws) {
    ...
    async function handleMessage(raw) {
      ...
      const wsMessageHandlers = {
        ...
        input() {
          sessionManager.writeInput(clientId, msg.data, msg.session);
        },
        resize() {
            ...
            const thisPeer = createServerPeer(
              ...
              (chunk) => {
                try {
                  ...
                  if (p2pMsg.type === "input" && typeof p2pMsg.data === "string") sessionManager.writeInput(clientId, p2pMsg.data, p2pMsg.session);
