...
/**
 * Get the cursor position (row, col) for a tmux pane.
 * Returns 1-based row/col matching ANSI escape conventions, or null on failure.
 */
export async function getCursorPosition(name) {
  ...
  // tmux returns 0-based; ANSI CUP (ESC[row;colH) is 1-based
