    ...
    { method: "POST", path: "/upload", handler: auth(csrf(async (req, res) => {
      ...
      if (process.platform === "darwin") {
        ...
        try {
          ...
          clipboard = true;
          // Allow macOS clipboard to fully propagate before responding.
          // Without this delay, CLI tools reading the clipboard immediately
          // after Ctrl+V may get the previous clipboard contents.
